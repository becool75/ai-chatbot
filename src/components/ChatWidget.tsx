...
export default function ChatWidget() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages([
        ...newMessages,
        { role: "assistant", message: "Entschuldigung, es gab einen Fehler. Bitte versuchen Sie es erneut." },
      ]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-6 bottom-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-blue-600 text-white shadow-lg transition-all hover:bg-blue-500 hover:shadow-xl"
      >
        {isOpen ? (
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed right-6 bottom-24 z-50 flex h-[500px] w-[380px] flex-col overflow-hidden rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl">
          {/* Header */}
